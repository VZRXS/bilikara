...
class StageSyncLogicTest(unittest.TestCase):
    ...
    def test_host_uses_shared_renderer_and_tauri_lifecycle_is_main_only(self):
        ...
        self.assertIn("renderer.ensureOverlay", app_source)
        self.assertIn("stageRendererApi()?.renderOverlay", app_source)
        self.assertIn('document.createElement("video")', app_source)
        self.assertIn('document.createElement("audio")', app_source)
