...
"""
    ...
    def test_compact_header_has_one_unified_menu_trigger(self):
        ...
        self.assertIn('<rect x="10.4" y="4.5" width="3.2" height="1.4" rx="0.7" fill="currentColor" stroke="none"></rect>', header)
        self.assertIn('<path d="M10 19h4" stroke-width="1"></path>', header)
...
"""
    ...
    def test_now_playing_uses_deduplicated_toasts_for_exceptional_states_only(self):
        ...
        self.assertNotIn('t("remote.controlCachePending")', controls)
        self.assertNotIn("reportRemoteIssue(cachePendingIssueSignature", controls)
